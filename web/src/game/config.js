...
export const ATOM_WHITE = 'white'
export const ATOM_GRAY = 'gray'
export const COLORS = [ATOM_BLACK, ATOM_RED, ATOM_BLUE, ATOM_GREEN, ATOM_YELLOW, ATOM_PURPLE, ATOM_WHITE, ATOM_GRAY]
