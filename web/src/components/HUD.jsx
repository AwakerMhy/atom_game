...
const RULES_OVERLAY_LINES = [
  ...
  "",
  "一、目标",
  "将对方生命降至 0。每方 3 格，格点可放置黑/红/蓝/绿/黄原子。",
  "",
  "二、游戏阶段",
  "阶段1：排布。拖放原子到己方格，点「结束排布」。",
  "阶段2：效果。点击己方红/蓝/绿/黄原子发动效果。",
  ...
  "黄：对方必须以有黄原子的格子为攻击对象（若有多个有黄原子的格，可任选其一攻击，但不能攻击无黄原子的格）。",
  "",
  "六、原子点击效果",
  "红：先选对方格子，再在该格内随机破坏 y 个黑原子（y = 该红原子相邻黑数）。",
  "蓝：与该蓝相邻的黑原子下一回合内不可被破坏，期间蓝色高亮。",
  "绿：该绿原子就地变为黑原子（不消耗池）。",
  "黄：与该黄相邻的黑原子（黄色高亮，可与蓝高亮同时显示）下回合内当格子被攻击或遭红效果时优先被选为破坏对象。",
  "",
  "八、黑原子破坏规则（攻击与红效果）",
  "要破坏 x 个黑原子时：",
